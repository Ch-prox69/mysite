...
class AsyncToSync(Generic[_P, _R]):
    ...
    def __call__(self, *args: _P.args, **kwargs: _P.kwargs) -> _R:
        ...
        # static event loop's thread if it's there, otherwise make a new loop
        # in this thread.
        try:
...
class SyncToAsync(Generic[_P, _R]):
    ...
    outermost), this will just be the static thread. This is achieved by idling
    ...
    # Storage for static event loop references
